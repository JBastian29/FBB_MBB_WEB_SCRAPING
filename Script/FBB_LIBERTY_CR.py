...
def scrape_liberty_data():
    urls = {
        "3 - play": [
            "https://libertycr.com/triple-play"
        ],
        "2 - play ": [
            "https://libertycr.com/doble-play"
        ],
        "internet": [
            "https://libertycr.com/internet-hogar/planes"
        ]
    }
    ...
    with pd.ExcelWriter('FBB_liberty_plans_full.xlsx', engine='xlsxwriter') as writer:
