...
def scrape_digicel_data():
    urls = {
        "JA  - Fiber Bundles": [
            "https://www.digicelgroup.com/jm/en/home-and-entertainment/bundles"
        ],
        "JA  - Fiber": [
            "https://www.digicelgroup.com/jm/en/home-and-entertainment/home-internet"
        ],
        "T&T  - Fiber": [
            "https://www.digicelgroup.com/tt/en/home-and-entertainment/home-internet"
        ],
        "T&T  - Bundles": [
            "https://www.digicelgroup.com/tt/en/home-and-entertainment/fibre-bundles"
        ]
    }
    ...
    with pd.ExcelWriter('FBB_digicel_plans_full.xlsx', engine='xlsxwriter') as writer:
        for country, links in urls.items():
            for link in links:
                try:
                    ...
                    plans = soup.find_all("div", class_="service-plan-card")
