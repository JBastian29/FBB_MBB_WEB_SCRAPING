...
def scrape_altice_data():
    urls = {
        "FIBER - 3 play": [
            "https://www.altice.com.do/personal/hogar/planes/tripleplay/red-fibra"
        ],
        "2 play - int + tv": [
            "https://www.altice.com.do/personal/hogar/planes/dobleplay/tv-internet"
        ],
        "2 play - int + voice": [
            "https://www.altice.com.do/personal/hogar/planes/dobleplay/voz-internet"
        ]
    }
    ...
    with pd.ExcelWriter('FBB_altice_plans_full.xlsx', engine='xlsxwriter') as writer:
        for country, links in urls.items():
            for link in links:
                try:
                    ...
                    plans = soup.find_all("div", class_="plan-container")
