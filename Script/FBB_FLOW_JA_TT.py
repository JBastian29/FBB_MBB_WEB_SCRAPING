...
def scrape_flow_data():
    urls = {
        "JA  - Int+Mobile": [
            "https://discoverflow.co/jamaica/internet-bundles"
        ],
        "JA  - Internet": [
            "https://discoverflow.co/jamaica/broadband/overview"
        ],
        "JA  - Int + TV": [
            "https://discoverflow.co/jamaica/internet-tv"
        ],
        "T&T  - Bundles": [
            "https://discoverflow.co/trinidad/bundles/overview"
        ],
        "T&T  - Internet": [
            "https://discoverflow.co/trinidad/internet"
        ],
        "T&T  - TV Plan": [
            "https://discoverflow.co/trinidad/tv/flow-tv"
        ]
    }
    ...
    with pd.ExcelWriter('FBB_flow_plans_full.xlsx', engine='xlsxwriter') as writer:
