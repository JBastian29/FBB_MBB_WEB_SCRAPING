...
def scrape_mbb_flow_data():
    urls = {
        "JA  - Postpaid": [
            "https://discoverflow.co/jamaica/mobile/plans/postpaid"
        ],
        "JA  - Prepaid": [
    ...
    with pd.ExcelWriter('MBB_flow_plans_full.xlsx', engine='xlsxwriter') as writer:
