...
def scrape_cablecolor_data():
    ...
    with pd.ExcelWriter('cablecolor_plans_full.xlsx', engine='xlsxwriter') as writer:
        for country, links in urls.items():
            for link in links:
                try:
                    ...
                    plans = soup.find_all("div", class_="container_plan")
