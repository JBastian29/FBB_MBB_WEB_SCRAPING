...
def scrape_masmovil_data():
    urls = {
        "internet": [
            "https://www.masmovilpanama.com/residencial/paquetes-internet"
        ],
        "hogar": [
            "https://www.masmovilpanama.com/residencial/paquetes-hogar"
        ]
    }
    ...
    with pd.ExcelWriter('FBB_masmovil_plans_full.xlsx', engine='xlsxwriter') as writer:
