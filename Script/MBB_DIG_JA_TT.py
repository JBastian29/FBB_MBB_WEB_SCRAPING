...
def scrape_mbb_digicel_data():
    urls = {
        "JA  - Postpaid": [
            "https://www.digicelgroup.com/jm/en/postpaid"
        ],
        "JA  - Prepaid": [
            "https://www.digicelgroup.com/jm/en/prepaid"
        ],
        "TT  - Postpaid": [
            "https://www.digicelgroup.com/tt/en/postpaid"
        ],
        "TT  - Prepaid": [
            "https://www.digicelgroup.com/tt/en/prepaid"
        ]
    }
    ...
    with pd.ExcelWriter('MBB_diicel_plans_full.xlsx', engine='xlsxwriter') as writer:
